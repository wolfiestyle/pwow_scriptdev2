...
static EntryTypeMap const CreatureEntryToType = map_initializer<EntryTypeMap>
    ...
    (NPC_HALION_TWILIGHT,   DATA_HALION_T)
...
static EntryTypeMap const GameObjectEntryToType = map_initializer<EntryTypeMap>
    ...
    (GO_HALION_TWILIGHT_RING, DATA_HALION_TWILIGHT_RING)
    ...
    (GO_PORTAL_T_TWILIGHT_1, DATA_PORTAL_TO_TWILIGHT_1)
    (GO_PORTAL_F_TWILIGHT_2, DATA_PORTAL_FROM_TWILIGHT_2)
    (GO_PORTAL_T_TWILIGHT_2, DATA_PORTAL_TO_TWILIGHT_2)
    ;
