...
#define SONIC_SCREECH_TIMER     urand(30, 35)*IN_MILISECONDS
#define SENTINEL_BLAST_TIMER    urand(15, 20)*IN_MILISECONDS
#define TERRIFY_SCREECH_TIMER   urand(30, 40)*IN_MILISECONDS
#define GUARDIAN_SWARM_TIMER    urand(25, 30)*IN_MILISECONDS
#define SUMMON_DEFENDER_TIMER   60*IN_MILISECONDS
#define SAVAGE_POUNCE_TIMER     urand(15, 20)*IN_MILISECONDS
#define FERAL_RUSH_TIMER        urand(20, 25)*IN_MILISECONDS
#define FERAL_POUNCE_TIMER      urand(15, 20)*IN_MILISECONDS
