...
#define SHADOW_CRASH_TIMER          urand(15, 20)*IN_MILISECONDS
#define MARK_OF_THE_FACELESS_TIMER  urand(15, 20)*IN_MILISECONDS
#define SEARING_FLAMES_TIMER        urand(20, 30)*IN_MILISECONDS
#define SURGE_OF_DARKNESS_TIMER     urand(60, 70)*IN_MILISECONDS
