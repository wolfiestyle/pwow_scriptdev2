...
#define CHAIN_LIGHTNING_TIMER       urand(15, 20)*IN_MILISECONDS
#define UNBALANCING_STRIKE_TIMER    urand(20, 30)*IN_MILISECONDS
#define LIGHTNING_CHARGE_TIMER      urand(45, 60)*IN_MILISECONDS
