...
struct MANGOS_DLL_DECL mob_scarlet_courier_controllerAI : public ScriptedAI
{
    ...
    void UpdateAI(const uint32 diff) 
    {
        ...
        {
            Creature *pCourier = m_creature->SummonCreature(NPC_SCARLET_COURIER, 1461.65f, -6010.34f, 116.369f, 0.0f, TEMPSUMMON_TIMED_DESPAWN, 180000);
